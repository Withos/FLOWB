            ...
            <div class="events" id="events_container">
                ...
                <div class="event" id="event_1">
                    ...
                    <div class="event_information">
                        ...
                        <h2 onclick="location.href='event?id=<?=$event->getId()?>'"><?=$event->getTitle()?></h2>
                        <p class="location"><?= $event->getLocation()?></p>
                        <p class="description"><?= $event->getDescription() ?></p>
                        <?php
                            if(array_search($event->getId(), array_column($interested, "interested_eventID")) !== false){
                        ?>
                        <div class="interested interest_button" role="button">
                            <?php
                            }else{
                            ?>
                            <div class="uninterested interest_button" role="button">
                            <?php
                            }
                            ?>
                            <p class="interest_text">Interested</p>
...
<template id="event_template">
    <div class="event" role="button" onclick="">
        <img src="">
        <div class="event_information">
            <p class="date">date</p>
            <h2>Title?></h2>
            ...
            <div class="interest_button" role="button">
                <p class="interest_text">Interested</p>
                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.875 2.625H6.125C5.1625 2.625 4.38375 3.4125 4.38375 4.375L4.375 18.375L10.5 15.75L16.625 18.375V4.375C16.625 3.4125 15.8375 2.625 14.875 2.625ZM14.875 15.75L10.5 13.8425L6.125 15.75V4.375H14.875V15.75Z" fill="#e6e6e6"/>
                </svg>
